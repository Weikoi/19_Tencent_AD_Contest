# -*- coding: utf-8 -*-
# @Time    : 2019/4/30 14:46
# @Author  : YYLin
# @Email   : 854280599@qq.com
# @File    : Dataload_Exposure_Data.py
import pandas as pd
import datetime
import time
import pickle as pk
...
# Exposure_Log_Data = pd.read_csv('../Ad_Operation_Data.csv')
# Ad_op_id = Exposure_Log_Data['ad_id'].drop_duplicates(keep='first', inplace=False)
# # 使用pandas进行去重操作 该代码暂不使用
# list_Ad_op_id = list(Ad_op_id)
# print('操作广告数据集中list的长度是：', len(list_Ad_op_id), list_Ad_op_id[0:5], type(list_Ad_op_id[0]))
...
#
#         if tmp_ad_id not in list_Ad_op_id:
...
#                 continue
#             elif tmp_line >= cmp_time_17 and tmp_line <= cmp_time_17_night:
#                 Total_Exposure_Log_Data_17.append(line)
#                 continue
#             elif tmp_line >= cmp_time_18 and tmp_line <= cmp_time_18_night:
#                 Total_Exposure_Log_Data_18.append(line)
#                 continue
#             elif tmp_line >= cmp_time_19 and tmp_line <= cmp_time_19_night:
#                 Total_Exposure_Log_Data_19.append(line)
#                 continue
#             elif tmp_line >= cmp_time_20 and tmp_line <= cmp_time_20_night:
#                 Total_Exposure_Log_Data_20.append(line)
#                 continue
#             elif tmp_line >= cmp_time_21 and tmp_line <= cmp_time_21_night:
#                 Total_Exposure_Log_Data_21.append(line)
#                 continue
#             elif tmp_line >= cmp_time_22 and tmp_line <= cmp_time_22_night:
#                 Total_Exposure_Log_Data_22.append(line)
#                 continue
#             elif tmp_line >= cmp_time_23 and tmp_line <= cmp_time_23_night:
#                 Total_Exposure_Log_Data_23.append(line)
#                 continue
#             elif tmp_line >= cmp_time_24 and tmp_line <= cmp_time_24_night:
#                 Total_Exposure_Log_Data_24.append(line)
#                 continue
#             elif tmp_line >= cmp_time_25 and tmp_line <= cmp_time_25_night:
#                 Total_Exposure_Log_Data_25.append(line)
#                 continue
#             elif tmp_line >= cmp_time_26 and tmp_line <= cmp_time_26_night:
#                 Total_Exposure_Log_Data_26.append(line)
#                 continue
#             elif tmp_line >= cmp_time_27 and tmp_line <= cmp_time_27_night:
#                 Total_Exposure_Log_Data_27.append(line)
#                 continue
#             elif tmp_line >= cmp_time_28 and tmp_line <= cmp_time_28_night:
#                 Total_Exposure_Log_Data_28.append(line)
#                 continue
#             elif tmp_line >= cmp_time_01 and tmp_line <= cmp_time_01_night:
#                 Total_Exposure_Log_Data_301.append(line)
#                 continue
#             elif tmp_line >= cmp_time_02 and tmp_line <= cmp_time_02_night:
#                 Total_Exposure_Log_Data_302.append(line)
#                 continue
#             elif tmp_line >= cmp_time_03 and tmp_line <= cmp_time_03_night:
#                 Total_Exposure_Log_Data_303.append(line)
#                 continue
#             elif tmp_line >= cmp_time_04 and tmp_line <= cmp_time_04_night:
#                 Total_Exposure_Log_Data_304.append(line)
#                 continue
#             elif tmp_line >= cmp_time_05 and tmp_line <= cmp_time_05_night:
#                 Total_Exposure_Log_Data_305.append(line)
#                 continue
#             elif tmp_line >= cmp_time_06 and tmp_line <= cmp_time_06_night:
#                 Total_Exposure_Log_Data_306.append(line)
#                 continue
#             elif tmp_line >= cmp_time_07 and tmp_line <= cmp_time_07_night:
#                 Total_Exposure_Log_Data_307.append(line)
#                 continue
#             elif tmp_line >= cmp_time_08 and tmp_line <= cmp_time_08_night:
#                 Total_Exposure_Log_Data_308.append(line)
#                 continue
#             elif tmp_line >= cmp_time_09 and tmp_line <= cmp_time_09_night:
#                 Total_Exposure_Log_Data_309.append(line)
#                 continue
#             elif tmp_line >= cmp_time_310 and tmp_line <= cmp_time_310_night:
#                 Total_Exposure_Log_Data_310.append(line)
#                 continue
#             elif tmp_line >= cmp_time_311 and tmp_line <= cmp_time_311_night:
#                 Total_Exposure_Log_Data_311.append(line)
#                 continue
#             elif tmp_line >= cmp_time_312 and tmp_line <= cmp_time_312_night:
#                 Total_Exposure_Log_Data_312.append(line)
#                 continue
#             elif tmp_line >= cmp_time_313 and tmp_line <= cmp_time_313_night:
#                 Total_Exposure_Log_Data_313.append(line)
#                 continue
#             elif tmp_line >= cmp_time_314 and tmp_line <= cmp_time_314_night:
#                 Total_Exposure_Log_Data_314.append(line)
#                 continue
#             elif tmp_line >= cmp_time_315 and tmp_line <= cmp_time_315_night:
#                 Total_Exposure_Log_Data_315.append(line)
#                 continue
#             elif tmp_line >= cmp_time_316 and tmp_line <= cmp_time_316_night:
#                 Total_Exposure_Log_Data_316.append(line)
#                 continue
#             elif tmp_line >= cmp_time_317 and tmp_line <= cmp_time_317_night:
#                 Total_Exposure_Log_Data_317.append(line)
#                 continue
#             elif tmp_line >= cmp_time_318 and tmp_line <= cmp_time_318_night:
#                 Total_Exposure_Log_Data_318.append(line)
#                 continue
#             elif tmp_line >= cmp_time_319 and tmp_line <= cmp_time_319_night:
...
Total_Exposure_Log_Data_March = pd.concat(
    [pd.read_csv('../Dataset/data/Total_Exposure_Log_Data_03' + str(i).zfill(2) + '.csv', names=Exposure_Log_Data_columns) for i
